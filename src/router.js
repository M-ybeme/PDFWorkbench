...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            ...toolRoutes.map((tool) => ({
                path: tool.path,
                element: tool.id === "viewer" ? (viewerElement) : tool.id === "merge" ? (mergeElement) : tool.id === "split" ? (splitElement) : tool.id === "editor" ? (editorElement) : (_jsx(ToolPlaceholder, { tool: tool })),
            })),
