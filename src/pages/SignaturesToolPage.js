...
const SignaturesToolPage = () => {
  ...
  return _jsxs("div", {
    className: "mx-auto flex max-w-full flex-col gap-4 px-4 py-6 lg:px-8",
    children: [
      _jsx("div", {
        ...dropZoneProps,
        className: clsx(
            ...
            _jsxs("div", {
              children: [
                _jsx("p", {
                  ...
                  children: "Load a PDF to start stamping signatures",
                }),
                _jsxs("p", {
                  className: "text-sm text-slate-500 dark:text-slate-300",
                  children: ["Files stay in your browser. ", SIGNATURE_DISCLAIMER_COPY],
                }),
              ],
            }),
            _jsxs("div", {
              ...
              children: [
                ...
                _jsx("input", { id: "signature-upload", ...inputProps }),
                _jsx("span", {
      ...
      error
        ? _jsx("div", {
            className:
              "rounded-2xl border border-rose-200 bg-rose-50/80 px-4 py-3 text-sm text-rose-800 dark:border-rose-500/40 dark:bg-rose-500/10 dark:text-rose-100",
            children: error,
          })
        : null,
      status === "ready" && pdf
        ? _jsxs(_Fragment, {
            children: [
              ...
              _jsxs("section", {
                className:
                  "rounded-2xl border border-slate-200/70 bg-white/80 p-4 shadow-inner dark:border-white/10 dark:bg-slate-900/70",
                children: [
                  _jsxs("div", {
                    className:
                      "flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 pb-3 text-sm text-slate-500 dark:border-white/5 dark:text-slate-300",
                    children: [
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("button", {
                            type: "button",
                            className:
                              "rounded-full border border-slate-300 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-slate-600 disabled:opacity-40 dark:border-white/10 dark:text-white",
                            onClick: () => setCurrentPage((page) => Math.max(1, page - 1)),
                            disabled: currentPage === 1,
                            children: "Prev",
                          }),
                          _jsxs("span", { children: ["Page ", currentPage, " / ", pdf.pageCount] }),
                          _jsx("button", {
                            type: "button",
                            className:
                              "rounded-full border border-slate-300 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-slate-600 disabled:opacity-40 dark:border-white/10 dark:text-white",
                            onClick: () =>
                              setCurrentPage((page) => Math.min(pdf.pageCount, page + 1)),
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          ...
                          _jsxs("span", { children: [Math.round(zoom * 100), "%"] }),
                        ],
                      }),
                    ],
                  }),
                  _jsx("div", {
                    ...
                    children: _jsxs("div", {
                      className:
                        "relative flex min-h-[420px] w-full max-w-[900px] items-center justify-center",
                      style: {
                      ...
                      children: [
                              ...
                              : _jsxs(_Fragment, {
                                  children: [
                                    ...
                                    strokesForCurrentPage.length === 0
                                      ? _jsx("div", {
                                          className:
                                            "absolute inset-0 flex items-center justify-center text-sm text-slate-500",
                                        ...
                                        "div",
                                        {
                                          ...
                                          children: [
                                            _jsx("img", {
                                              ...
                                              alt: signature.label,
                                              className:
                                                "h-full w-full rounded-xl object-contain shadow-sm",
                                              draggable: false,
                                            }),
                                            isSelected
                                              ? _jsxs(_Fragment, {
                                                  children: [
                                                    _jsx("div", {
                                                      className:
                                                        "absolute inset-0 rounded-2xl border-2 border-indigo-400 shadow-[0_0_0_2px_rgba(79,70,229,0.25)]",
                                                    }),
                                                    _jsx("div", {
                                                    ...
                                                    _jsx("div", {
                                                      className:
                                                        "absolute -bottom-2 -right-2 h-6 w-6 cursor-se-resize rounded-full border-2 border-white bg-indigo-500",
                                                      onPointerDown: startPlacementDrag(
                                                        "signature",
                                                        placement,
                                                        "resize",
                                        ...
                                        "div",
                                        {
                                          ...
                                          children: [
                                            _jsx("div", {
                                              ...
                                              children: _jsx("div", {
                                                className:
                                                  "pointer-events-none whitespace-pre-wrap text-sm text-slate-900",
                                                style: {
                                                  fontSize: `${placement.fontSizePt}px`,
                                                  color: placement.color,
                                                  lineHeight: 1.3,
                                                },
                                                children: placement.text || "(Empty text)",
                                              }),
                                            }),
                                            isSelected
                                              ? _jsxs(_Fragment, {
                                                  children: [
                                                    _jsx("div", {
                                                      className:
                                                        "absolute inset-0 cursor-move rounded-2xl",
                                                      onPointerDown: startPlacementDrag(
                                                        "text",
                                                        placement,
                                                        "move",
                                                    ...
                                                    _jsx("div", {
                                                      className:
                                                        "absolute -bottom-2 -right-2 h-6 w-6 cursor-se-resize rounded-full border-2 border-white bg-emerald-500",
                                                      onPointerDown: startPlacementDrag(
                                                        "text",
                                                        placement,
                                                        "resize",
                        ...
                        canvasSize.width === 0
                          ? _jsx("div", {
                              className:
                                "absolute inset-0 flex items-center justify-center rounded-2xl border border-slate-200/80 bg-white/70 text-sm text-slate-500 dark:border-white/10 dark:bg-slate-900/70",
                              children: "Rendering page preview...",
                            })
                          : null,
                      ],
                    }),
