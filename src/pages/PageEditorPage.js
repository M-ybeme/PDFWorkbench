        ...
        children: _jsxs("div", {
          ...
          children: [
            _jsx("p", {
              ...
              children: pdf ? "Page editor ready" : "Reorder, rotate, and curate",
            }),
            _jsx("p", {
            ...
            _jsxs("div", {
              ...
              children: [
                ...
                _jsx("input", { id: "editor-upload", ...inputProps }),
                _jsx("span", {
              ...
              _jsxs("div", {
                ...
                children: [
                    ...
                    children: [
                      _jsxs("div", {
                        children: [
                          ...
                          _jsxs("p", {
                            className: "text-xs uppercase tracking-wide text-slate-400",
                            children: [activePages.length, " active / ", totalPages, " total"],
                          }),
                        ],
                      }),
                      _jsxs("div", {
                  ...
                  downloadError
                    ? _jsx("p", {
                        className:
                          "mt-3 rounded-2xl border border-red-200 bg-red-50/80 px-4 py-2 text-sm text-red-700 dark:border-red-900/30 dark:bg-red-900/20 dark:text-red-100",
                  ...
                  downloadSuccess
                    ? _jsx("p", {
                        className:
                          "mt-3 rounded-2xl border border-emerald-200 bg-emerald-50/80 px-4 py-2 text-sm text-emerald-700 dark:border-emerald-900/30 dark:bg-emerald-900/20 dark:text-emerald-100",
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      _jsx("p", {
                        ...
                        children: "Drag to reorder \u00B7 Rotate \u00B7 Delete",
                      }),
                      _jsx("p", {
                        className: "text-xs text-slate-400",
                        children: "Thumbnails render locally; no uploads leave your device.",
                      }),
                    ],
                  }),
                  pages.length === 0
                    ...
                    : _jsxs(_Fragment, {
                        children: [
                                ...
                                "div",
                                {
                                  ...
                                  children: [
                                    _jsxs("div", {
                                      ...
                                      children: [
                                        _jsxs("span", { children: ["Page ", index + 1] }),
                                        page.isDeleted
                                          ? _jsx("span", {
                                    ...
                                    _jsxs("div", {
                                      className:
                                        "relative aspect-[3/4] overflow-hidden rounded-xl border border-slate-200/80 bg-slate-50 dark:border-white/10 dark:bg-slate-900/40",
                                      children: [
                                        thumbnails[page.id]
                                          ? _jsx("img", {
                                          ...
                                          : _jsx("span", {
                                              className:
                                                "absolute inset-0 flex items-center justify-center text-xs text-slate-400",
                                              children: "Rendering\u2026",
                                            }),
                                        page.isDeleted
                                          ? _jsx("span", {
                                    ...
                                    _jsxs("div", {
                                      className:
                                        "flex flex-wrap items-center gap-2 text-xs font-semibold uppercase tracking-wide",
                                      children: [
                                        _jsx("button", {
                                          type: "button",
                                          className:
                                            "flex-1 rounded-full border border-slate-200/80 px-2 py-1 text-slate-600 transition hover:border-slate-400 hover:text-slate-900 dark:border-white/20 dark:text-slate-200 dark:hover:border-white/40 dark:hover:text-white",
                                          onClick: (event) => {
                                        ...
                                        _jsx("button", {
                                          ...
                                          children: page.isDeleted ? "Restore" : "Delete",
                                        }),
                                      ],
                                    }),
                                  ],
                          ...
                          _jsx("div", {
                            className:
                              "mt-4 rounded-2xl border border-dashed border-slate-300/70 px-4 py-2 text-center text-xs text-slate-400 dark:border-white/20",
                            role: "button",
                            ...
                            children: "Drag here to move a page to the end",
                          }),
                        ],
                      }),
                ],
