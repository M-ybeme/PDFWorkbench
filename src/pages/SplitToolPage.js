  ...
  return _jsxs("div", {
    ...
    children: [
        ...
        children: _jsxs("div", {
          ...
          children: [
            _jsx("p", {
              ...
              children: pdf ? "Ready to split" : "Split PDFs with precision",
            }),
            _jsx("p", {
            ...
            _jsxs("div", {
              ...
              children: [
                _jsx("label", {
                  ...
                  className:
                    "inline-flex cursor-pointer items-center gap-2 rounded-full bg-slate-900 px-5 py-2 text-sm font-semibold text-white transition hover:bg-slate-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 dark:bg-white dark:text-slate-900",
                  children: pdf ? "Replace PDF" : "Choose a PDF",
                }),
                _jsx("input", { id: "split-upload", ...inputProps }),
                _jsx("span", {
                  className: "text-xs uppercase tracking-wide text-slate-400",
                  children: "or drag anywhere in this panel",
                }),
                pdf
                  ? _jsx("button", {
                      type: "button",
                      className:
                        "text-xs font-semibold uppercase tracking-wide text-slate-500 underline-offset-2 hover:underline dark:text-slate-300",
      ...
      status === "loading"
        ? _jsx("div", {
            className:
              "rounded-2xl border border-slate-200/80 bg-white/80 px-4 py-3 text-sm text-slate-600 dark:border-white/10 dark:bg-slate-900/60 dark:text-slate-300",
      ...
      pdf
            ...
            children: [
              _jsxs("div", {
                ...
                children: [
                  _jsxs("section", {
                    className:
                      "rounded-3xl border border-slate-200/80 bg-white/90 p-5 dark:border-white/10 dark:bg-slate-900/70",
                    children: [
                      _jsxs("div", {
                        ...
                        children: [
                          _jsxs("div", {
                            children: [
                              ...
                              _jsxs("p", {
                                className: "text-sm text-slate-500 dark:text-slate-300",
                                children: [pdf.pageCount, " pages - ", formatBytes(pdf.size)],
                              }),
                            ],
                          }),
                          _jsxs("div", {
                            className: "text-xs text-slate-400 dark:text-slate-300",
                            children: ["PDF v", pdf.pdfVersion],
                          }),
                        ],
                      }),
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("button", {
                            type: "button",
                            className:
                              "rounded-full border border-slate-200 px-4 py-1 text-slate-600 transition hover:border-slate-300 dark:border-white/10 dark:text-slate-200",
                  ...
                  _jsxs("section", {
                    ...
                    children: [
                      _jsxs("div", {
                        ...
                        children: [
                          ...
                          _jsx("button", {
                            ...
                            children: isSelectionDownloading
                              ? "Preparing..."
                              : selectionCount === 0
                                ? "Select pages"
                                : "Download selection",
                      ...
                      selectionError
                        ? _jsx("p", {
                            className:
                              "mt-3 rounded-2xl border border-red-200 bg-red-50/80 px-4 py-2 text-sm text-red-800 dark:border-red-900/40 dark:bg-red-900/20 dark:text-red-100",
                      ...
                      selectionSuccess
                        ? _jsx("p", {
                            className:
                              "mt-3 rounded-2xl border border-emerald-200 bg-emerald-50/80 px-4 py-2 text-sm text-emerald-900 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-100",
                            children: selectionSuccess,
                          })
                        : null,
                    ],
                  }),
                        ...
                        children: [
                          ...
                          _jsxs("div", {
                            ...
                            children: [
                              _jsx("label", {
                                className:
                                  "text-xs uppercase tracking-wide text-slate-400 dark:text-slate-300",
                                htmlFor: "page-interval-input",
                                children: "Page interval",
                              }),
                              _jsx("input", {
                                type: "number",
                                min: 1,
                                ...
                                className:
                                  "w-32 rounded-2xl border border-slate-300/70 bg-transparent px-3 py-2 text-sm dark:border-white/20",
                              }),
                            ],
                          }),
                          _jsx("button", {
                            ...
                            children: isBundleDownloading
                              ? "Bundling..."
                              : `Create ${splitSize}-page slices`,
                          }),
                        ],
                      }),
                      bundleError
                  ...
                  _jsxs("section", {
                    ...
                    children: [
                          ...
                          return _jsxs(
                            "button",
                            {
                              ...
                              children: [
                                ...
                                _jsxs("div", {
                                  className:
                                    "mt-3 flex items-center justify-between text-xs font-semibold uppercase tracking-wide",
                                  children: [
                                    _jsxs("span", {
                                    ...
                                    _jsx("span", {
                                      ...
                                      children: isSelected ? "Selected" : "Tap to add",
                                    }),
                                  ],
                                }),
                              ],
                      ...
                      thumbnails.length === 0 && thumbnailStatus !== "rendering"
                        ? _jsx("p", {
                            className: "mt-4 text-sm text-slate-500 dark:text-slate-300",
                            children: "Drop a PDF to see live thumbnails for selection.",
                          })
                        : null,
                    ],
                  }),
              ...
              _jsxs("aside", {
                className:
                  "space-y-4 rounded-3xl border border-slate-200/80 bg-white/90 p-5 dark:border-white/10 dark:bg-slate-900/70",
                children: [
                  _jsxs("div", {
                    children: [
                      _jsx("p", {
                      ...
                      _jsxs("ul", {
                        className: "mt-3 space-y-1 text-sm text-slate-600 dark:text-slate-200",
                        children: [
                          _jsxs("li", { children: ["Total pages: ", pdf.pageCount] }),
                          _jsxs("li", { children: ["Selected pages: ", selectionCount] }),
                          _jsxs("li", {
                            children: ["Interval preset: every ", splitSize, " page(s)"],
                          }),
                        ],
                      }),
                    ],
                  ...
                  _jsxs("div", {
                    className:
                      "rounded-3xl border border-slate-900/10 bg-slate-900 p-4 text-sm text-white dark:border-white/10",
                    children: [
                      _jsx("p", {
                        className: "font-semibold uppercase tracking-wide text-white/70",
                        children: "Workflow tips",
                      }),
                      _jsxs("ul", {
                        className: "mt-3 space-y-2 text-white/80",
                        children: [
                          _jsx("li", { children: "Use odd/even shortcuts for alternating pulls." }),
                          _jsx("li", {
                            children:
                          ...
                          _jsx("li", {
                            children:
                              "Selection export keeps thumbnail order even after multiple toggles.",
                          }),
                        ],
                      }),
                    ],
        ...
        : _jsx("section", {
            className:
              "rounded-3xl border border-slate-200/80 bg-white/90 p-6 text-sm text-slate-500 dark:border-white/10 dark:bg-slate-900/70 dark:text-slate-300",
            children:
