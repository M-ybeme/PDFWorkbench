...
const CompressionToolPage = () => {
  ...
  return _jsxs("div", {
    className: "mx-auto flex max-w-6xl flex-col gap-6 px-4 py-8 lg:px-10",
    children: [
      _jsx("div", {
        ...dropZoneProps,
        className: clsx(
        ...
        children: _jsxs("div", {
          ...
          children: [
            _jsx("p", {
              ...
              children: pdf ? "Ready for compression preview" : "Compress image-heavy PDFs",
            }),
            _jsx("p", {
            ...
            _jsxs("div", {
              ...
              children: [
                _jsx("label", {
                  ...
                  className:
                    "inline-flex cursor-pointer items-center gap-2 rounded-full bg-slate-900 px-5 py-2 text-sm font-semibold text-white transition hover:-translate-y-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 dark:bg-white dark:text-slate-900",
                  children: pdf ? "Replace PDF" : "Choose a PDF",
                }),
                _jsx("input", { id: "compression-upload", ...inputProps }),
                _jsx("span", {
                  className: "text-xs uppercase tracking-[0.4em] text-slate-400",
                  children: "or drag files anywhere in this panel",
                }),
              ],
            }),
          ],
      ...
      status === "loading"
        ? _jsx("div", {
            className:
              "rounded-2xl border border-amber-200 bg-amber-50/80 px-4 py-3 text-sm text-amber-900 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-50",
            children: "Loading PDF details...",
          })
        : null,
      loadError
        ? _jsx("div", {
            className:
              "rounded-2xl border border-red-200 bg-red-50/80 px-4 py-3 text-sm text-red-800 dark:border-red-900/40 dark:bg-red-900/20 dark:text-red-100",
            children: _jsxs("div", {
              className: "flex items-center justify-between gap-4",
              children: [
                _jsx("p", { children: loadError }),
                _jsx("button", {
      ...
      compressionError
        ? _jsx("div", {
            ...
            children: _jsxs("div", {
              className: "flex items-center justify-between gap-4",
              children: [
                _jsx("p", { children: compressionError }),
                _jsx("button", {
                  className: "text-xs font-semibold uppercase",
      ...
      compressionSuccess
        ? _jsx("div", {
            className:
              "rounded-2xl border border-emerald-200 bg-emerald-50/80 px-4 py-3 text-sm text-emerald-900 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-50",
            children: _jsxs("div", {
              className: "flex items-center justify-between gap-4",
              children: [
                _jsx("p", { children: compressionSuccess }),
                _jsx("button", {
                  className: "text-xs font-semibold uppercase",
      ...
      pdf
        ? _jsxs("div", {
            className: "grid gap-6 lg:grid-cols-[1.75fr,1fr]",
            children: [
              _jsxs("section", {
                className:
                  "space-y-6 rounded-3xl border border-slate-200/70 bg-white/90 p-6 shadow-xl shadow-slate-200/40 dark:border-white/10 dark:bg-slate-900/70",
                children: [
                  _jsxs("div", {
                    ...
                    children: [
                      _jsxs("div", {
                        children: [
                          _jsx("p", {
                            className:
                              "text-sm uppercase tracking-[0.4em] text-slate-500 dark:text-slate-400",
                            children: "Quality presets",
                          }),
                          _jsx("p", {
                            className: "text-2xl font-semibold text-slate-900 dark:text-white",
                            children: "Choose how aggressive to go",
                          }),
                        ],
                      }),
                      _jsx("button", {
                        type: "button",
                        className:
                          "text-xs font-semibold uppercase tracking-widest text-slate-500 underline-offset-4 hover:text-slate-900 hover:underline dark:text-slate-300",
                  ...
                  _jsx("div", {
                    ...
                    children: COMPRESSION_PRESETS.map((preset) => {
                        ...
                        "button",
                        {
                          ...
                          children: [
                            ...
                            _jsxs("p", {
                              ...
                              children: [
                                "Target ~",
                                Math.round(preset.targetRatio * 100),
                                "% of original",
                              ],
                            }),
                          ],
                  ...
                  _jsx("div", {
                    className:
                      "rounded-2xl border border-slate-200/70 bg-slate-50/60 px-4 py-3 text-sm text-slate-700 dark:border-white/10 dark:bg-slate-800/40 dark:text-slate-300",
                    children:
                      "Each page is rendered to canvas and re-encoded as JPEG at the selected quality threshold. Text and vector sharpness may soften since the output is rasterized. Best results on image-heavy scanned documents.",
                  }),
                  _jsxs("div", {
                    ...
                    children: [
                      _jsxs("div", {
                        className:
                          "rounded-2xl border border-slate-200/80 bg-white/60 p-4 text-sm text-slate-600 dark:border-white/10 dark:bg-slate-900/60 dark:text-slate-300",
                        children: [
                          _jsx("p", {
                            className:
                          ...
                          _jsx("p", {
                            ...
                            children: formatBytes(pdf.size),
                          }),
                          _jsxs("p", {
                            className: "text-xs text-slate-400",
                            children: [pdf.pageCount, " pages"],
                          }),
                        ],
                      }),
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("p", {
                            ...
                            children: lastResult ? "Compressed" : "Projected",
                          }),
                          _jsx("p", {
                  ...
                  _jsxs("div", {
                    className:
                      "flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-slate-200/70 bg-slate-50/80 p-4 dark:border-white/10 dark:bg-slate-900/60",
                    children: [
                      _jsxs("div", {
                        children: [
                          _jsx("p", {
                      ...
                      _jsx("button", {
                        type: "button",
                        className:
                          "rounded-full bg-slate-900 px-5 py-2 text-sm font-semibold text-white transition disabled:opacity-40 dark:bg-white dark:text-slate-900",
                        onClick: handleCompress,
                        disabled: !canCompress,
                        children: isCompressing ? "Compressing..." : "Compress & Download",
                      }),
                    ],
                  }),
                ],
              ...
              _jsxs("aside", {
                ...
                children: [
                  _jsxs("div", {
                    className:
                      "rounded-3xl border border-slate-200/70 bg-white/90 p-5 text-sm text-slate-600 shadow-xl shadow-slate-200/40 dark:border-white/10 dark:bg-slate-900/70 dark:text-slate-300",
                    children: [
                      _jsx("p", {
                        className: "text-xs uppercase tracking-[0.4em] text-slate-400",
                        children: "PDF details",
                      }),
                      _jsx("p", {
                        className: "mt-2 text-base font-semibold text-slate-900 dark:text-white",
                        children: pdf.name,
                      }),
                      _jsxs("ul", {
                        className: "mt-3 space-y-1",
                        children: [
                          _jsxs("li", { children: ["Size: ", formatBytes(pdf.size)] }),
                          _jsxs("li", { children: ["Pages: ", pdf.pageCount] }),
                          _jsxs("li", { children: ["PDF.js version: ", pdf.pdfVersion] }),
                          _jsxs("li", {
                            children: ["Page size: ", formatPageSize(pdf.metadata.pageSize)],
                          }),
                          _jsxs("li", { children: ["Title: ", pdf.metadata.title ?? "—"] }),
                          _jsxs("li", { children: ["Author: ", pdf.metadata.author ?? "—"] }),
                          _jsxs("li", {
                            children: [
                              "Created: ",
                              formatTimestamp(pdf.metadata.creationDate ?? pdf.lastModified),
                            ],
                          }),
                          _jsxs("li", {
                            children: [
                              "Modified: ",
                              formatTimestamp(pdf.metadata.modificationDate),
                            ],
                          }),
                        ],
                      }),
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsx("ul", {
                        ...
                        children: guardrailMessages.map((message) =>
                          _jsx("li", { children: message }, message),
                        ),
                      }),
                    ],
                  }),
                  _jsxs("div", {
                    className:
                      "rounded-3xl border border-dashed border-slate-300/70 p-5 text-sm text-slate-500 dark:border-white/20 dark:text-slate-400",
                    children: [
                      _jsx("p", {
                        className: "font-semibold text-slate-700 dark:text-slate-200",
                        children: "Next implementation beats",
                      }),
                      _jsx("ul", {
                        className: "mt-3 list-disc space-y-2 pl-4",
                        children: futureTracks.map((item) => _jsx("li", { children: item }, item)),
                      }),
                    ],
                  }),
                ],
        ...
        : _jsx("div", {
            className:
              "rounded-3xl border border-slate-200/70 bg-white/80 p-6 text-center text-sm text-slate-600 dark:border-white/10 dark:bg-slate-900/60 dark:text-slate-300",
            children:
              "Load a PDF to unlock preset controls, projected savings, and preview exports.",
          }),
      _jsx(PasswordPromptModal, {
