...
const ImagesToPdfPage = () => {
    ...
    const onFilesReceived = useCallback((files) => {
        void handleFiles(files);
    }, [handleFiles]);
    const { isDragActive: isDragging, inputProps, dropZoneProps, openFilePicker, } = useDragDrop({
        accept: "image/*",
        multiple: true,
