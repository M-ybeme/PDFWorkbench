...
const ImagesToPdfPage = () => {
  ...
  return _jsxs("div", {
    className: "mx-auto flex max-w-6xl flex-col gap-6 px-4 py-8 lg:flex-row lg:px-10",
    children: [
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              _jsx("p", {
                className:
                  "text-xs font-semibold uppercase tracking-[0.4em] text-slate-500 dark:text-slate-400",
                children: "0.5.x \u00B7 Images \u2192 PDF",
              }),
              _jsx("h1", {
                className: "mt-4 font-display text-4xl text-slate-900 dark:text-white",
                children: "Drag in images, tune layout, download a polished PDF.",
              }),
              _jsxs("p", {
                ...
                children: [
                  "Add up to ",
                  MAX_IMAGES,
                  " images. Reorder them, choose the right page preset, and export a perfectly sized PDF without leaving the browser.",
                ],
              }),
              _jsxs("div", {
                ...
                children: [
                  _jsx("button", {
                    type: "button",
                    className:
                      "inline-flex items-center gap-3 rounded-full bg-slate-900 px-6 py-3 text-white shadow-lg shadow-slate-900/30 transition hover:-translate-y-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-slate-900 dark:bg-white dark:text-slate-900",
                  ...
                  _jsx("button", {
                    type: "button",
                    className:
                      "text-sm text-slate-500 underline-offset-4 hover:text-slate-900 hover:underline dark:text-slate-300",
                    onClick: clearAll,
                    disabled: emptyState,
                    children: "Clear list",
                  }),
                  _jsx("input", { id: "images-upload", ...inputProps }),
                ],
              }),
              status
                ? _jsx("p", {
                    className: "mt-4 text-sm text-emerald-600 dark:text-emerald-300",
                    children: status,
                  })
                : null,
              error
          ...
          _jsxs("div", {
            className:
              "rounded-3xl border border-slate-200/70 bg-white/80 p-6 dark:border-white/10 dark:bg-slate-900/60",
            children: [
              _jsxs("div", {
                  ...
                  _jsxs("div", {
                    children: [
                      _jsx("p", {
                        ...
                        children: "Image queue",
                      }),
                      _jsxs("p", {
                        className: "text-lg font-semibold text-slate-900 dark:text-white",
                        children: [images.length, " added \u00B7 ", totalSizeMb, " MB"],
                      }),
                    ],
                  }),
                  _jsx("button", {
                    type: "button",
                    className:
                      "rounded-full border border-slate-300/70 px-4 py-2 text-sm text-slate-600 transition hover:border-slate-600 hover:text-slate-900 dark:border-white/10 dark:text-slate-300",
                    onClick: () => openFilePicker(),
                    children: "Add more",
                  }),
                ],
              ...
              emptyState
                ? _jsx("p", {
                    ...
                    children:
                      "Need inspiration? Drop PNG, JPG, or WEBP files here. We'll keep them local and render lightweight previews before exporting.",
                  })
                : _jsx("ul", {
                    className: "mt-6 space-y-4",
                    "data-image-list": "true",
                    children: images.map((image, index) =>
                      _jsxs(
                        "li",
                        {
                          className:
                            "flex flex-col gap-4 rounded-2xl border border-slate-200/70 bg-white/70 p-4 dark:border-white/10 dark:bg-slate-900/40 sm:flex-row",
                          children: [
                            _jsxs("div", {
                              ...
                              children: [
                                ...
                                _jsxs("div", {
                                  ...
                                  children: [
                                    _jsxs("p", {
                                      className:
                                        "font-semibold text-slate-900 dark:text-white break-all",
                                      children: ["Page ", index + 1, ": ", image.name],
                                    }),
                                    _jsxs("p", {
                            ...
                            _jsxs("div", {
                              ...
                              children: [
                                _jsx("button", {
                                  type: "button",
                                  className:
                                    "rounded-full border border-slate-300/70 px-4 py-1 text-xs font-semibold uppercase tracking-wide text-slate-600 transition hover:border-slate-900 hover:text-slate-900 disabled:opacity-30 dark:border-white/10 dark:text-slate-300",
                                ...
                                _jsx("button", {
                                  type: "button",
                                  className:
                                    "rounded-full border border-rose-200/70 px-4 py-1 text-xs font-semibold uppercase tracking-wide text-rose-600 transition hover:border-rose-500 hover:text-rose-700 dark:border-rose-500/30 dark:text-rose-300",
      ...
      _jsxs("aside", {
        className:
          "w-full rounded-3xl border border-slate-200/70 bg-white/80 p-6 dark:border-white/10 dark:bg-slate-900/60 lg:w-80",
        children: [
          _jsx("p", {
          ...
          _jsx("div", {
            ...
            children: PAGE_PRESETS.map((option) => {
              ...
              return _jsxs(
                "label",
                {
                  ...
                  children: [
                    ...
                    _jsxs("div", {
                      children: [
                        _jsx("p", { className: "font-semibold", children: option.label }),
                        _jsxs("p", {
                          className: "text-xs uppercase tracking-[0.3em] text-slate-400",
                          children: [option.width, " \u00D7 ", option.height, " pt"],
                        }),
                      ],
                    }),
                  ],
              ...
              _jsxs("div", {
                children: [
                  ...
                  _jsx("div", {
                    ...
                    children: ["portrait", "landscape"].map((option) =>
                      _jsx(
                        "button",
                        {
                          type: "button",
              ...
              _jsxs("div", {
                children: [
                  ...
                  _jsx("div", {
                    ...
                    children: FIT_OPTIONS.map((option) => {
          ...
          _jsxs("div", {
            className: "mt-8 space-y-3 text-sm text-slate-500 dark:text-slate-300",
            children: [
              _jsxs("p", {
                children: [
                  "Each image becomes its own page. We'll apply a ",
                  DEFAULT_MARGIN / 72,
                  '" margin.',
                ],
              }),
              _jsx("p", {
                children: "Everything stays on-device\u2014no uploads or external servers.",
              }),
            ],
          }),
          _jsx("button", {
            type: "button",
            className:
              "mt-6 w-full rounded-2xl bg-emerald-600 px-4 py-3 text-center font-semibold text-white shadow-lg shadow-emerald-600/40 transition hover:-translate-y-0.5 disabled:opacity-40",
