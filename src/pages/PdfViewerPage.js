...
const PdfViewerPage = () => {
  ...
  const canvasElement = _jsx("canvas", {
    ref: canvasRef,
    className: "mx-auto shadow-2xl shadow-slate-900/10",
  });
  const ThumbnailSidebar = () =>
    _jsxs("aside", {
      className:
        "rounded-2xl border border-slate-200/80 bg-white/80 p-3 text-sm shadow-sm dark:border-white/10 dark:bg-slate-900/70 lg:w-60",
      children: [
        _jsxs("div", {
        ...
        _jsx("div", {
          className: "mt-3 max-h-[420px] overflow-y-auto pr-2",
          children:
            thumbnails.length > 0
              ? _jsx("ol", {
                  className: "space-y-3",
                      ...
                      "li",
                      {
                        children: _jsxs("button", {
                          ...
                          children: [
                            _jsx("div", {
                              className:
                                "overflow-hidden rounded-xl border border-slate-200/60 bg-slate-100 dark:border-white/10 dark:bg-slate-900/40",
                              children: _jsx("img", {
                                src: thumb.url,
                            ...
                            _jsxs("span", {
                              className:
                                "mt-2 block text-xs font-semibold uppercase tracking-[0.3em]",
                              children: ["Page ", thumb.pageNumber],
                            }),
                          ],
                        }),
                      },
        ...
        _jsxs("div", {
          ...
          children: [
            _jsxs("div", {
              ...
              children: ["Page ", currentPage, " / ", pdf?.pageCount ?? 0],
            }),
            _jsxs("div", {
              ...
              children: [
                _jsx("button", {
                  type: "button",
                  className:
                    "rounded-full border border-slate-300 px-3 py-1 disabled:opacity-40 dark:border-white/20",
            ...
            _jsxs("div", {
              ...
              children: [
                _jsx("button", {
                  type: "button",
                  className:
                    "rounded-full border border-slate-300 px-2 py-1 text-lg leading-none disabled:opacity-40 dark:border-white/20",
                  onClick: () =>
                ...
                _jsxs("span", {
                  className:
                    "w-20 text-center text-xs uppercase tracking-[0.3em] text-slate-500 dark:text-slate-400",
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsxs("header", {
        className:
          "rounded-3xl border border-slate-200/70 bg-white/80 p-8 shadow-lg dark:border-white/10 dark:bg-slate-900/70",
        children: [
          _jsx("p", {
            className: "text-xs uppercase tracking-[0.4em] text-slate-500 dark:text-slate-400",
            children: "0.2.0",
          ...
          _jsx("h1", {
            className: "mt-3 font-display text-4xl font-semibold text-slate-900 dark:text-white",
            children: "PDF Viewer MVP",
          }),
          _jsx("p", {
            className: "mt-4 max-w-2xl text-base text-slate-600 dark:text-slate-300",
            children:
              "Load a PDF entirely in your browser, render crisp pages via pdf.js, and prime the layout for thumbnails, metadata, and downstream editing flows.",
          }),
        ],
      }),
      _jsxs("section", {
        ...
        children: [
          _jsxs("div", {
            className:
              "rounded-3xl border border-slate-200/70 bg-white/90 p-6 shadow-md dark:border-white/10 dark:bg-slate-900/70",
            children: [
              _jsxs("div", {
                className: clsx(
                ...
                ...dropZoneProps,
                children: [
                  _jsx("input", { id: "viewer-upload", ...inputProps }),
                  _jsxs("label", {
                    htmlFor: "viewer-upload",
                    className: "flex flex-col items-center gap-1",
                    children: [
                      _jsx("span", {
                        className:
                          "text-sm font-semibold tracking-wide text-slate-700 dark:text-slate-200",
                        children: "Bring your PDF",
                      }),
                      _jsx("span", {
                        className: "text-xs text-slate-500 dark:text-slate-400",
                        children: "Drop a file or click to browse. Everything stays on-device.",
                      }),
                    ],
                  }),
                  _jsx("p", {
                    className: "text-xs uppercase tracking-[0.3em] text-slate-400",
                    children: status === "loading" ? "Loading…" : "Idle",
                  }),
                ],
              }),
              error &&
                _jsx("p", {
                  className:
                    "mt-4 rounded-2xl border border-rose-200 bg-rose-50 px-3 py-2 text-sm text-rose-700 dark:border-rose-900/60 dark:bg-rose-950/60 dark:text-rose-200",
                  children: error,
                }),
              pdf &&
                pageDetail &&
                _jsxs("dl", {
                  ...
                  children: [
                    _jsxs("div", {
                      className: "rounded-2xl bg-slate-100/60 p-3 dark:bg-slate-800/60",
                      children: [
                        _jsx("dt", {
                        ...
                        _jsx("dd", {
                          className:
                            "text-base font-semibold text-slate-900 dark:text-white break-all",
                          children: pdf.name,
                        }),
                      ],
                    }),
                    ...
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsx("dd", {
                          className: "text-base font-semibold text-slate-900 dark:text-white",
                          children: docInfo?.created ?? "Not available",
                        }),
                      ],
                    }),
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsx("dd", {
                          className: "text-base font-semibold text-slate-900 dark:text-white",
                          children: docInfo?.modified ?? "Not available",
                        }),
                      ],
                    }),
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsx("dd", {
                          className: "text-base font-semibold text-slate-900 dark:text-white",
                          children: docInfo?.pageSizeLabel ?? "Not available",
                        }),
                      ],
                    }),
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsx("dd", {
                          className: "text-base font-semibold text-slate-900 dark:text-white",
                          children: docInfo?.permissions ?? "Not available",
                        }),
                      ],
                    }),
                    _jsx("button", {
                      type: "button",
                      className:
                        "w-full rounded-2xl border border-slate-300/60 px-3 py-2 text-sm font-semibold text-slate-600 transition hover:border-slate-400 hover:text-slate-900 dark:border-white/20 dark:text-slate-200",
                      onClick: reset,
                      children: "Clear file",
                    }),
                  ],
          ...
          _jsx("div", {
            className:
              "flex flex-col rounded-3xl border border-slate-200/70 bg-slate-900/5 p-4 backdrop-blur dark:border-white/10 dark:bg-white/5",
            children: pdf
              ? _jsxs(_Fragment, {
                  children: [
                    ...
                    !isFullscreen
                      ? _jsxs("div", {
                          ...
                          children: [
                            _jsx(ThumbnailSidebar, {}),
                            _jsx("div", {
                              className:
                                "flex-1 overflow-auto rounded-2xl border border-dashed border-slate-300/70 bg-white/90 p-4 shadow-inner dark:border-white/10 dark:bg-slate-950/40",
                      ...
                      : _jsx("div", {
                          className:
                            "mt-4 rounded-2xl border border-dashed border-slate-300/70 bg-white/70 p-6 text-center text-sm text-slate-500 dark:border-white/10 dark:bg-slate-900/40 dark:text-slate-300",
                          children:
              ...
              : _jsxs("div", {
                  className:
                    "flex flex-1 flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300/70 bg-white/70 p-10 text-center text-slate-500 dark:border-white/20 dark:bg-slate-900/40 dark:text-slate-300",
                  children: [
                    _jsx("p", {
                    ...
                    _jsx("p", {
                      className: "mt-2 font-display text-2xl text-slate-800 dark:text-white",
                      children: "Drop a PDF to preview the first page.",
                    }),
                    _jsx("p", {
                      className: "mt-3 max-w-lg text-sm text-slate-500 dark:text-slate-400",
                      children:
                        "Once the viewer solidifies, this pane will host thumbnails, metadata, and editing affordances for the rest of the toolchain.",
                    }),
                  ],
                }),
          }),
                ...
                children: [
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsx("div", {
                        className:
                          "flex-1 overflow-auto rounded-2xl border border-white/20 bg-slate-900/50 p-4 shadow-inner",
                        children: canvasElement,
                      }),
                    ],
                  }),
