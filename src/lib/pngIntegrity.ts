...
const matchesSignature = (bytes: Uint8Array) => {
...
export const hasPngSignature = (bytes: Uint8Array): boolean => matchesSignature(bytes);
 ...
 */
export const isPngBytesComplete = (bytes: Uint8Array): boolean => {
