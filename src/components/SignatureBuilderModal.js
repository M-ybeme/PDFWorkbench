  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      _jsx("div", {
        ...
        className:
          "relative z-10 w-full max-w-4xl rounded-3xl border border-slate-100 bg-white/95 p-6 shadow-2xl dark:border-white/10 dark:bg-slate-950/95",
        children: _jsxs("div", {
          ...
          children: [
            _jsxs("div", {
              ...
              children: [
                ...
                _jsx("h2", {
                  ...
                  children: "Create a signature stamp",
                }),
                _jsx("p", {
                  id: "signature-modal-desc",
                  className: "text-sm text-slate-500 dark:text-slate-400",
                  children: SIGNATURE_DISCLAIMER_COPY,
                }),
              ],
            }),
            _jsx("div", {
            ...
            _jsxs("div", {
              ...
              children: [
                    ...
                    _jsxs("label", {
                      ...
                      children: [
                        ...
                        _jsx("input", {
                          ...
                          className:
                            "mt-1 w-full rounded-2xl border border-slate-200 bg-white px-4 py-2 text-sm text-slate-900 shadow-sm focus:border-slate-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 dark:border-white/10 dark:bg-slate-900 dark:text-white",
                      ...
                      ? _jsxs("div", {
                          ...
                          children: [
                            _jsxs("div", {
                              ...
                              children: [
                                _jsx("span", { children: "Ink color:" }),
                                _jsx("div", {
                                  className: "flex gap-2",
                                  children: COLOR_OPTIONS.map((color) =>
                                    _jsx(
                                      "button",
                                      {
                                        type: "button",
                                ...
                                _jsx("button", {
                                  type: "button",
                                  className:
                                    "ml-auto text-xs font-semibold uppercase tracking-widest text-slate-400 hover:text-slate-600",
                                  onClick: resetCanvas,
                                  children: "Clear",
                                }),
                              ],
                            ...
                            _jsx("div", {
                              className:
                                "overflow-hidden rounded-2xl border border-dashed border-slate-300/80 bg-white shadow-inner dark:border-white/10 dark:bg-slate-900",
                    ...
                    mode === "type"
                      ? _jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsxs("div", {
                              children: [
                                ...
                                _jsx("div", {
                                  ...
                                  children: TYPEFACE_OPTIONS.map((option) =>
                                    _jsx(
                                      "button",
                                      {
                                        type: "button",
                            ...
                            _jsx("div", {
                              className:
                                "rounded-2xl border border-dashed border-slate-300/70 bg-white/70 px-6 py-6 text-center text-3xl text-slate-800 shadow-inner dark:border-white/10 dark:bg-slate-900 dark:text-white",
                              children: _jsx("span", {
                                style: { fontFamily: typedTypeface.previewFont, color: typedColor },
                                children: typedValue || "Your Name",
                              }),
                            }),
                          ],
                        })
                    ...
                    mode === "upload"
                      ? _jsxs("div", {
                          ...
                          children: [
                            _jsxs("label", {
                              className:
                                "flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300/70 bg-white/70 px-6 py-10 text-center text-sm text-slate-500 shadow-inner dark:border-white/10 dark:bg-slate-900",
                              children: [
                                _jsx("input", {
                                  type: "file",
                                ...
                                _jsx("span", {
                                  ...
                                  children: "Click to choose a PNG signature",
                                }),
                                _jsx("span", {
                                  className: "text-xs text-slate-400",
                                  children: "Transparent backgrounds preserve best results.",
                                }),
                              ],
                            }),
                            uploadError
                            ...
                            uploadPreview
                              ? _jsx("div", {
                                  className:
                                    "rounded-2xl border border-slate-200 bg-white p-4 text-center shadow-inner dark:border-white/10 dark:bg-slate-900",
                                  children: _jsx("img", {
                ...
                _jsxs("div", {
                  className:
                    "space-y-4 rounded-2xl border border-slate-200/80 bg-white/80 p-4 dark:border-white/10 dark:bg-slate-900/70",
                  children: [
                    _jsx("p", {
                      className: "text-xs font-semibold uppercase tracking-[0.3em] text-slate-400",
                      children: "Preview",
                    ...
                    mode === "draw"
                      ? _jsx("div", {
                          className:
                            "rounded-2xl border border-dashed border-slate-300/70 bg-slate-50/80 p-6 text-center text-sm text-slate-500 dark:border-white/10 dark:bg-slate-950/40",
                          children: drawnPreviewSrc
                            ? _jsx("img", {
                                src: drawnPreviewSrc,
                                alt: "Drawn signature preview",
                                className: "mx-auto max-h-40 object-contain",
                              })
                            : _jsx("p", { children: "Use the drawing pad to sketch a signature." }),
                        })
                      : null,
                    mode === "type"
                      ? _jsx("div", {
                          className:
                            "rounded-2xl border border-dashed border-slate-300/70 bg-slate-50/80 p-6 text-center text-3xl text-slate-900 dark:border-white/10 dark:bg-slate-950/40 dark:text-white",
                          style: { fontFamily: typedTypeface.previewFont, color: typedColor },
                          children: typedValue || "Your Name",
                        })
                      : null,
                    mode === "upload"
                      ? _jsx("div", {
                          className:
                            "rounded-2xl border border-dashed border-slate-300/70 bg-slate-50/80 p-6 text-center dark:border-white/10 dark:bg-slate-950/40",
                          children: uploadPreview
                            ...
                            : _jsx("p", {
                                className: "text-sm text-slate-500 dark:text-slate-400",
                                children: "Upload a transparent PNG to preview it here.",
                              }),
                        })
                      : null,
                    _jsx("div", {
                      className:
                        "rounded-2xl border border-slate-200/80 bg-slate-50/60 px-4 py-3 text-xs text-slate-500 dark:border-white/10 dark:bg-slate-900/60 dark:text-slate-300",
                      children: _jsx("p", {
                        children:
                          "Tips: keep signatures under 900px wide, use transparent backgrounds, and avoid colors that blend into your document.",
                      }),
                    }),
                  ],
                }),
            ...
            _jsxs("div", {
              ...
              children: [
                _jsx("button", {
                  type: "button",
                  className:
                    "rounded-full px-4 py-2 text-sm font-semibold text-slate-500 transition hover:text-slate-700 dark:text-slate-300",
                  onClick: closeModal,
                  children: "Cancel",
                }),
                _jsx("button", {
                  type: "button",
                  className:
                    "rounded-full bg-slate-900 px-6 py-2 text-sm font-semibold text-white transition disabled:opacity-40 dark:bg-white dark:text-slate-900",
                  disabled: !canSave,
                  onClick: handleSave,
