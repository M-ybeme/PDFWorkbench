...
const DropZone = ({ isDragActive, accentColor, dropZoneProps, children, className, }) => (_jsx("div", { ...dropZoneProps, className: clsx("rounded-[32px] border-2 border-dashed p-10 transition-colors", isDragActive ? activeColorMap[accentColor] : inactiveStyle, className), children: children }));
