  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("input", {
        ...
        className:
          "w-40 bg-transparent text-sm text-slate-800 outline-none placeholder:text-slate-400 dark:text-white dark:placeholder:text-slate-500 sm:w-56",
        "aria-label": "Search text",
      }),
      matchDisplay
        ? _jsx("span", {
            className: "whitespace-nowrap text-xs text-slate-500 dark:text-slate-400",
            children: matchDisplay,
          })
        : null,
      _jsx("button", {
        type: "button",
